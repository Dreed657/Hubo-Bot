...
exports.run = async (client, message, args) => {
    ...
    const a = message.guild.roles.get('603274579590512650'); // Moderator
    const b = message.guild.roles.get('267665927187726337'); // Administrator
    const c = message.guild.roles.get('603274831546286111'); // Developer
